...
public class Ventana extends JFrame implements ActionListener {
    ...
    JFrame v;
    JPanel p1,p2,p3;
    JLabel lTexto,ltitulo,ldeterminante,lrango;
    ...
    private void pintarresultado(int tamaño) {
        ...
        for(int i = 0;i<tamaño;i++){
            for(int j = 0; j<tamaño;j++){
                ...
                matrixresul.get(index).setBounds(20 +(j*55),20+(i*25), 50, 20);
        ...
        lrango.setBounds(20, 50 + (tamaño)*25, 150, 20);
        batras.setBounds(20, 60 + ((tamaño+1)*25), 100, 20);
